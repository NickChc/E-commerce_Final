...
export const SFooter = styled.div`
  ${tw`w-full flex flex-col items-center justify-center relative z-10 border-solid border border-x-0 border-b-0 `}
  ${(props) => css`
...
export const SFooterInfo = styled.div`
  ${tw`xs:w-[80%] sm:w-[70%] py-9 h-[400px] flex items-start justify-around `}
  ${(props) => css`
    color: ${props.theme.colors["additional"]};
  `}

  h2 {
    ${tw`m-3 text-[.9rem] whitespace-nowrap xs:text-[1rem] sm:text-lg md:text-2xl`}
  }
  ...
  a {
    ${tw`m-3 no-underline flex items-center text-[.65rem] xs:text-[0.8rem] sm:text-[1rem] shrink hover:underline `}
    ${(props) => css`
...
export const SInfobar = styled.div`
  ${tw`w-[40%] inline-flex flex-col items-center justify-center`}
`;
