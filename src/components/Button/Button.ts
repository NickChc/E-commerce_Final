...
export const Button = styled.button<SButtonProps>`
  ...
  `}
  background-color: ${(props) => props.variation === "active" && props.theme.colors["additional"]};
  color: ${(props) => props.variation === "active" && props.theme.colors["secondary"]};

  :hover {
    ${tw`rounded-lg`}
    color: ${(props) => props.variation !== "active" && props.theme.colors["additional"]};
  }
